                                            ...
                                            <div class="card-body card-inline-0">
                                                <div class="table-responsive">
                                                    <table id="promoCodeTable"
                                                        ...
                                                        <thead>
                                                            <tr>
                                                                <th scope="col" style="text-align: center !important;">CODE</th>
                ...
                <div class="col-xxl-9 col-xl-12">
                                    ...
                                    <div class="form-group"> 
                                        <div class="input-group flatpickr-input-group">
                                            <input type="text" class="flatpickr-input active" id="daterangeinput"
                                                placeholder="<?=date('M d, Y', strtotime("-1 year"))?> to <?=date('M d, Y')?>" readonly="readonly">
                    ...
                    <div class="row">
                        <div class="col-xxl-6 col-xl-12">
                            <div class="card card-with-loader loading custom-card custom-card">
                                <div class="card-header justify-content-between border-bottom">
                        ...
                        <div class="col-xxl-6 col-xl-12">
                            <div class="card custom-card card-with-loader loading">
                                <div class="card-header justify-content-between border-bottom">
                    ...
                    <div class="row">
                        <div class="col-xxl-6 col-xl-12">
                            <div class="card card-with-loader loading  custom-card">
                                <div class="card-header justify-content-between border-bottom">
                        ...
                        flatpickr("#daterange", {
                            ...
                            onChange: function(selectedDates, dateStr, instance) {
                                if (selectedDates.length > 1) {
                                    $("#daterangeinput").val(`${moment(new Date(selectedDates[0])).format("MMM DD, YYYY")} to ${moment(new Date(selectedDates[1])).format("MMM DD, YYYY")}`);
                                    loadMainOverview(
