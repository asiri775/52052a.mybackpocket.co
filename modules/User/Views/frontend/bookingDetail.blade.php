                ...
                <div class="col-lg-6 col-sm-12 tab-view">
                    ...
                    <div class="card card-default full-height-n card-bordered p-4 card-radious">
                        <div class="booking-h-statuses">
                            @if (
                                $booking->status == \App\Helpers\Constants::BOOKING_STATUS_BOOKED or
                                $booking->status == \App\Helpers\Constants::BOOKING_STATUS_CHECKED_IN or
                                $booking->status == \App\Helpers\Constants::BOOKING_STATUS_CHECKED_OUT or
                                $booking->status == \App\Helpers\Constants::BOOKING_STATUS_COMPLETED or
                                $booking->status == \App\Helpers\Constants::BOOKING_STATUS_NO_SHOW or
                                    ...
                                    <div class="col-lg-4">
                                        ...
                                        @if ($row->available_from != '')
                                            <div class="icon-row small-space-info">
                                                ...
                                                <div class="icon-details ">
                                                    {{ date('h:i A', strtotime($row->available_from)) }}</div>
                                            </div>
                                        @endif
                                        @if ($row->available_to != '')
                                            <div class="icon-row small-space-info">
                                                <div class="icon-div"><span class="material-icons">schedule_send</span>
                                                </div>
                                                <div class="icon-details ">
                                                    {{ date('h:i A', strtotime($row->available_to)) }}</div>
                                            </div>
                                        @endif
                                        @if ($row->bed != '')
                                            <div class="icon-row small-space-info">
