<div class="form-checkout" id="form-checkout">
    ...
    <div class="form-section">
        ...
        <div class="row">
            <div class="col-md-6">
                <div class="form-group">
                    <label class="text-uppercase" style="font-size:12px">{{ __('First Name') }} <span class="required">*</span></label>
            ...
            <div class="col-md-6">
                <div class="form-group">
                    <label class="text-uppercase" style="font-size:12px">{{ __('Last Name') }} <span class="required">*</span></label>
            ...
            <div class="col-md-6 field-email">
                <div class="form-group">
                    <label class="text-uppercase" style="font-size:12px">{{ __('Email') }} <span class="required">*</span></label>
            ...
            <div class="col-md-6">
                <div class="form-group mobileNoFieldDataParent">
                    <label class="text-uppercase" style="font-size:12px">{{ __('Phone') }} <span class="required">*</span></label>
                    <input type="text" value="{{ $user->phone ?? '' }}"
                        placeholder="{{ __('Phone Number') }}" class="form-control mobileNoFieldData">
        ...
        <div class="row">
            ...
            <div class="col-md-6 field-password">
                <div class="form-group">
                    <label class="text-uppercase" style="font-size:12px">{{ __('New Password') }} <span class="required">*</span></label>
            ...
            <div class="col-md-6 field-confirm_password">
                <div class="form-group">
                    <label class="text-uppercase" style="font-size:12px">{{ __('Confirm Password') }} <span class="required">*</span></label>
        ...
        <div class="row">
            ...
            <div class="col-md-6 field-country">
                <div class="form-group">
                    <label class="text-uppercase" style="font-size:12px">{{ __('Country') }} </label>
    ...
    <div class="form-actions">
        <button class="btn btn-primary col-md-12" id="(anotherConfirmationBox)" @click="doCheckout">PROCEED TO CHECKOUT
        </button>

        <a onclick="return confirm('Are you sure you want to cancel this booking?')" class="btn btn-outline-primary col-md-12" href="{{route('cancelPendingBooking', $booking->code)}}">CANCEL</a>
    </div>
</div>
