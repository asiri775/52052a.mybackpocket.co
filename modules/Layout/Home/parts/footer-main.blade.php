...
<!-- Footer section -->
<script type="text/javascript" src="{{\App\Helpers\CodeHelper::withAppUrl('js/common.js')}}"></script>
...
<script type="text/javascript" src="{{\App\Helpers\CodeHelper::withAppUrl('js/signinpopup.js')}}?v={{config('app.version')}}"></script>

<!-- Menu ends -->


<script src="{{\App\Helpers\CodeHelper::withAppUrl('libs/lazy-load/intersection-observer.js')}}"></script>
<script async src="{{\App\Helpers\CodeHelper::withAppUrl('libs/lazy-load/lazyload.min.js')}}"></script>
<script>
...
<script type="text/javascript" src="{{\App\Helpers\CodeHelper::withAppUrl('js/datepikernew.js')}}"></script>
<script type="text/javascript">
    ...
    <footer class="mainfooter">
        <div class="container">
            <div class="footcol">
                ...
                <ul>
                    <li>
                        <a href="{{\App\Helpers\CodeHelper::withAppUrl('page/about-us')}}">About Us</a>
                    </li>
                    <li>
                        <a href="{{\App\Helpers\CodeHelper::withAppUrl('page/terms-of-service')}}">Terms and
                            Conditions</a>
                    </li>
                    <li>
                        <a href="{{\App\Helpers\CodeHelper::withAppUrl('page/privacy-policy')}}">Privacy Policy </a>
                    </li>
                </ul>
            ...
            <div class="footcol">
                ...
                <ul>
                    <li>
                        <a href="{{\App\Helpers\CodeHelper::withAppUrl('page/share-your-space')}}">Share Your Space </a>
                    </li>
                    {{-- <li>
                        <a href="{{\App\Helpers\CodeHelper::withAppUrl('page/host-faqs')}}">FAQs</a>
                    </li> --}}
                    <li>
                        <a href="{{\App\Helpers\CodeHelper::withAppUrl('register')}}">Sign Up</a>
                    </li>
                    <li>
                        <a href="{{\App\Helpers\CodeHelper::withAppUrl('contact')}}">Support</a>
                    </li>
                </ul>
            </div>
            <div class="footcol">
                ...
                <ul>
                    <li>
                        <a href="{{\App\Helpers\CodeHelper::withAppUrl('page/guests-how-it-works')}}">Be Our Guests</a>
                    </li>
                    <li>
                        <a href="{{\App\Helpers\CodeHelper::withAppUrl('contact')}}">Support</a>
                    </li>
            ...
            <div class="clearfix"></div>
            <div class="copyright">  
                Copyright &copy; {{date('Y')}} {{setting_item('site_title') ?? ''}}. All Rights Reserved.
            </div>
