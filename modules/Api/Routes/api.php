...
Route::group(['prefix' => 'user', 'middleware' => ['api'],], function ($router) {
    Route::get('booking-history', 'UserController@getBookingHistory')->name("api.user.bookings.details");
...
Route::group(['prefix' => 'checkout', 'middleware' => ['api'],], function ($router) 
{
Route::post('/updateTransactions/{id}', 'SearchController@UpdateTransactions')->name("api.checkout.update.transaction");
Route::post('/updateTransactionsDetails/{id}', 'SearchController@UpdateTransactionsDetails')->name("api.checkout.update.transaction.details");
Route::post('/updateUserCredits/{id}', 'SearchController@UpdateUserCredit')->name("api.checkout.update.user.credit");
Route::post('/updateBuyCreditData/{id}', 'SearchController@UpdateBuyCredit')->name("api.checkout.buy.credit");
