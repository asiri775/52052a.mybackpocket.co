                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3 col-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="country" id="customPlaceCountry" class="form-control"
...
?>
    <div class="panel">
        <div class="panel-title mb-0"><strong>{{ __(':name', ['name' => $attribute->name]) }}</strong></div>
        <?php
        if(strtolower($attribute->name) === "space type"){
            ?>
        <p style="padding: 0 13px;">Must select at least 1 Space Type</p>
        <?php
        }
        ?>
