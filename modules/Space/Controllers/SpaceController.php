...
class SpaceController extends Controller
{
    ...
    public function detail(Request $request, $slug)
    {
        ...
        $relatedSpaces = Space::where('status', 'publish')
            ->where('id', '!=', $row->id)
            ->whereRaw("(ST_Distance_Sphere(point(`map_lng`, `map_lat`), point(" . $row->map_lng . "," . $row->map_lat . "))) <= (50 / 0.001)")
            ->limit(12)->get();
    ...
    public function generator(Request $request)
    {
        if (($request->isMethod('post'))) {
            if (($request->has("title"))) {
                ...
                $yourApiKey = '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';
                ...
                $result = $client->completions()->create([
                    ...
                    'prompt' => 'Write something similar to this:
                    ...
                    Our listing offers two desks with seating capacity for up to 6 people. We offer a range of
                    convenient amenities including Free Wifi, Boardroom, Free Parking, Loading docks and a Coffee
                    station. We also offer helpful services such as Receptionist, Call Answering and Mail forwarding,
                    for a nominal fee
                    Shared office spaces promote collaboration, cost-effectiveness, and flexibility. By fostering
                    creativity through diverse interactions, reducing overheads, and offering flexible work
                    arrangements, these environments enhance productivity. Networking opportunities and modern
                    amenities further contribute to a dynamic and innovative work atmosphere.

                    From the following Information:' . $info . PHP_EOL . "do not say the latittude and longtitude but talk about the area around it",
                    'max_tokens' => 2000,
                ]);
